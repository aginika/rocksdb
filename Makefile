...
db_visualization: tools/db_visualization.o tools/parse_db_log.o $(LIBOBJECTS)
	$(CXX) tools/db_visualization.o tools/parse_db_log.o $(LIBOBJECTS) $(EXEC_LDFLAGS) -o $@  $(LDFLAGS) $(COVERAGEFLAGS)
